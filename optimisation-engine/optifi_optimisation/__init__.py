...
Sharpe ratio / tangency portfolio), Section 5.3 (the efficient frontier),
and HEDGING_SPEC.md Section 5's two defined-risk options structures
(protective put, collar). The full Mandate constraint taxonomy (Section
6, beyond generic per-asset weight bounds and the loss cap) and Section
8's gate-checking remain separate, not-yet-implemented future work.
"""
...
from .options_structures import collar, protective_put
